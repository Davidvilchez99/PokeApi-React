...
function Home(){
    return <>
    <ListaDatos/>
  <div class="cover-container ola d-flex w-100  p-3 mx-auto flex-column img">
    <main class="px-3">
      <h1>Bienvenido al mundo de las cryptos</h1>
      <p class="lead">Compra y vende más de 50 criptomonedas en DVA Crypto</p>
      {/* <p class="lead">
...
<section id="sobrenosotros" class="container marketing">
  ...
  <div class="row featurette">
    <div class="col-md-7">
      <h2 class="featurette-heading" id="nuestrosexpertosdicen">Gana criptomonedas gratis <span
          class="text-muted">mientras aprendes</span>
      </h2>
      <p class="lead">Mejora tus conocimientos sobre la cadena de bloques, completa cuestionarios y gana criptomonedas
        gratis.1. Inicia sesión en tu cuenta de Binance y visita la página principal de [Aprende y gana] en Binance
        Academy. Verás una lista de los cursos disponibles y la cantidad de recompensas de criptomonedas que puedes
        ganar después de completar el curso.2. Selecciona un curso y haz clic en [Empezar curso]. Sigue las
        instrucciones para aprender y completar el test. Si apruebas el test, recibirás un cupón de tokens como
        recompensa.
        3. Para consultar la distribución de recompensas, ve a [Historial de recompensas]. Ten en cuenta que las
        recompensas se distribuirán en un plazo de 48 horas si apruebas el test y cumples los requisitos de esta
        campaña.
      </p>
    </div>
    <div class="col-md-5">
